...
const baseInfo: {
  ...
  },
  {
    ...
    links: 'https://github.com/hyarriver',
    title: {
      text: 'hyarriver-io',
      className: 'm-l-md',
    },
...
const empiricInfo = [
  ...
  {
    text: `熟悉JavaScript、ES6、预编译sass,less，原生BOM、DOM对象。熟练运用Ajax、Json进行数据交互，常用Axios。`,
  },
  {
    text: `vue：熟练使用vue全家桶、熟练使用element、vant组件库进行项目开发；`,
  },
  {
    text: `熟练掌握vue数据响应式原理、promise底层机制；`,
  },
  {
    text: `开发过资讯类移动端应用，公众号端直播平台，能快速进行跨多尺寸、多平台设备开发，会用PhotoShop界面设计工具进行页面设计和原型切图。`,
  },
  {
    text: `能使用NodeJs、WebPack搭建开发环境，并使用过Express和MockJs开发过数据接口，Postman工具等进行接口测试。`,
  },
  {
    text: `熟悉使用Git版本控制，掌握Shell基本命令。了解TypeScript、node、Http协议、浏览器渲染、SPA应用，路由hash模式和history模式的底层原理等`,
  },
  {
